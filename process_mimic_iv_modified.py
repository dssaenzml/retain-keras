...
# Modified by Diego Saenz (dsaenzpe@icloud.com) to work with MIMIC-IV
# Usage: Put this script to the folder where MIMIC-IV CSV files are located. Then execute the below command.
